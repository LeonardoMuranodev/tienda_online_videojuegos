...
export default function CardProducto({ producto }) {
  ...
  return (
    <Card
      className={"flex flex-col w-[40vw] sm:w-48 rounded-xl overflow-hidden shadow-md".concat(" ", enStock? "bg-blue-400 border-blue-600 dark:bg-zinc-900 border dark:border-zinc-700 hover:scale-105 transition-all duration-300" : " border-none cursor-not-allowed bg-gray-600 dark:bg-zinc-900")}
